...
struct NativeStats: ThemeableWixel {
 ...
 static func spec() -> ThemedWidgetSpec { .init(widget: Self.self, defaultPlacement: .init(anchor: .bottomRight, offset: .init(width: -24, height: 32), size: .init(width: 220, height: 170), align: .trailing, sizing: .fitContent), namespace: "macos", previews: [.init("Normal", sample: .init(stats: .init(cpu: 32, mem: 61, battery: 82, charging: false, plugged: false), network: .init(connected: true, label: "Studio Wi-Fi"))), .init("Offline", sample: .init(stats: .init(cpu: 0, mem: 0, battery: 0, charging: false, plugged: false), network: .init(connected: false, label: "Offline")))]) { s, _ in .init(source: .init(cpu: s.cpu)) } }
